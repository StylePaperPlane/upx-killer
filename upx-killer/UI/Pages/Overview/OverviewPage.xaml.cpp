...
OverviewPage::OverviewPage() : m_viewModel(winrt::make<implementation::OverviewViewModel>()) {
  InitializeComponent();
...
winrt::upx_killer::OverviewViewModel OverviewPage::ViewModel() const { return m_viewModel; }

void OverviewPage::OnNavigatedTo(
    winrt::Microsoft::UI::Xaml::Navigation::NavigationEventArgs const& args) {
  auto const viewModel = args.Parameter().try_as<winrt::upx_killer::OverviewViewModel>();
